  ...
  return (
    <div className="bg-gradient-to-r mt-10 from-teal-100 via-blue-200 to-teal-300 py-16 px-6 sm:px-10 lg:px-16">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-12">
        {/* Card 1 */}
        <div className="bg-white rounded-lg shadow-xl transform transition duration-300 hover:scale-105 p-8 text-left">
          <div className="flex items-center mb-4">
            <span className="text-4xl text-green-600 mr-4">🌍</span>
            <h3 className="text-2xl font-semibold text-green-700">Expert Handmade Manufacturers</h3>
          </div>
        ...
        <div className="bg-white rounded-lg shadow-xl transform transition duration-300 hover:scale-105 p-8 text-left">
          <div className="flex items-center mb-4">
            <span className="text-4xl text-green-600 mr-4">💰</span>
            <h3 className="text-2xl font-semibold text-green-700">Wholesale Pricing & Bulk Discounts</h3>
          </div>
          <p className="text-lg text-gray-700">
        ...
        <div className="bg-white rounded-lg shadow-xl transform transition duration-300 hover:scale-105 p-8 text-left">
          <div className="flex items-center mb-4">
            <span className="text-4xl text-green-600 mr-4">🚀</span>
            <h3 className="text-2xl font-semibold text-green-700">Fast Global Shipping</h3>
          </div>
          <p className="text-lg text-gray-700">
        ...
        <div className="bg-white rounded-lg shadow-xl transform transition duration-300 hover:scale-105 p-8 text-left">
          <div className="flex items-center mb-4">
            <span className="text-4xl text-green-600 mr-4">🔖</span>
            <h3 className="text-2xl font-semibold text-green-700">Custom Orders & Branding</h3>
          </div>
          <p className="text-lg text-gray-700">
        ...
        <div className="bg-white rounded-lg shadow-xl transform transition duration-300 hover:scale-105 p-8 text-left">
          <div className="flex items-center mb-4">
            <span className="text-4xl text-green-600 mr-4">📦</span>
            <h3 className="text-2xl font-semibold text-green-700">Ethical & Sustainable Production</h3>
          </div>
          <p className="text-lg text-gray-700">
        ...
        <div className="bg-white rounded-lg shadow-xl transform transition duration-300 hover:scale-105 p-8 text-left">
          <div className="flex items-center mb-4">
            <span className="text-4xl text-green-600 mr-4">✅</span>
            <h3 className="text-2xl font-semibold text-green-700">Private-Label & Custom Branding Solutions</h3>
          </div>
          <p className="text-lg text-gray-700">
