...
const Video = () => {
  ...
  return (
    <div className=" md:h-[70vh] w-full flex justify-center items-center overflow-hidden opacity-100 scale-100">
      <video ref={video} className="w-full" autoPlay muted loop playsInline>
        <source
